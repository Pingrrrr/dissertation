...
class Kills(models.Model):
    ...
    attackerX = models.FloatField(null=True)
    attackerY = models.FloatField(null=True)
    attackerZ = models.FloatField(null=True)
    assister_ID = models.ForeignKey(Player, on_delete=models.SET_NULL, related_name='assister', null=True, blank=True)
    assisterX = models.FloatField(null=True)
    assisterY = models.FloatField(null=True)
    assisterZ = models.FloatField(null=True)
    victim_ID = models.ForeignKey(Player, on_delete=models.SET_NULL, related_name='victim', null=True, blank=True)
    victimX = models.FloatField(null=True)
    victimY = models.FloatField(null=True)
    victimZ = models.FloatField(null=True)
